                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="/therapist/patient-progress/{{$onlineSession['patient']->id}}" class="dropdown-item">View Progress Tracker</a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            ...
                                                            @else
                                                            <a href="/chats/convo/{{$onlineSession['chat_id']}}" class="dropdown-item">View Conversation</a>
                                                            @endif
                                                        ...
                                                        <li>
                                                            ...
                                                            <form action="/allow-evaluation/{{$onlineSession['patient']->id}}" method="POST">
                                                                @csrf
                                                            ...
                                                            @else
                                                            <form action="/cancel-evaluation/{{$onlineSession['patient']->id}}" method="POST">
                                                                @csrf
                                                                <button class="dropdown-item">
                                                                    Cancel Evaluation
                                                                </button>
