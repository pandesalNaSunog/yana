                    ...
                    <div class="col">
                        <div class="card shadow" style="border: none">
                            <div class="card-body">
                                ...
                                <h1 class="fw-bold fs-1 " style="font-size: 70px!important;">{{$patients}}</h1>
                    ...
                    <div class="col">
                        <div class="card shadow" style="border: none">
                            <div class="card-body">
                                ...
                                <h1 class="fw-bold fs-1 " style="font-size: 70px!important;">{{$therapists}}</h1>
                    ...
                    <div class="col">
                        <div class="card shadow" style="border: none">
                            <div class="card-body">
                                ...
                                <h1 class="fw-bold fs-1 " style="font-size: 70px!important;">{{$feedbacks}}</h1>
                    ...
                    <div class="col">
                        <div class="card shadow" style="border: none">
                            <div class="card-body">
                                ...
                                <h1 class="fw-bold fs-1 " style="font-size: 70px!important;">{{$posts}}</h1>
                                @if($post_rate < 1)
                    ...
                    <div class="col">
                        <div class="card shadow" style="border: none">
                            <div class="card-body">
                                ...
                                <h1 class="fw-bold fs-1 " style="font-size: 70px!important;">{{$average_comments}}</h1>
                                @if($comment_rate < 1)
                    ...
                    <div class="col">
                        <div class="card shadow" style="border: none">
                            <div class="card-body">
                                ...
                                <h1 class="fw-bold fs-1 " style="font-size: 70px!important;">{{$consultations}}</h1>
